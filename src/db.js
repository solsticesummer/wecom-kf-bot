...
// pure unit tests must still load `ai.js`/`retrieval.js` even with no DATABASE_URL.
//
// `pg` is CommonJS; in ESM we default-import and destructure Pool off it.
import pg from 'pg';
...
// and fall back to the full FAQ — see src/ai.js.
